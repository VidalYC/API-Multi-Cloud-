    ...
    >
      ...
      <div className="info-box">
        ...
        <div className="info-content">
          <h4>¿Qué es el Patrón Prototype?</h4>
          <p>
            El patrón Prototype permite crear nuevas VMs copiando configuraciones existentes (prototipos).
            Es ideal para:
          </p>
          <ul>
            <li>Escalar ambientes rápidamente</li>
            <li>Replicar configuraciones exitosas</li>
            <li>Crear múltiples instancias con configuración similar</li>
            <li>Mantener consistencia entre ambientes</li>
          </ul>
        </div>
      </div>
    </motion.div>
